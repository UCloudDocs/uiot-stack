...
| 功能名称                     | 链接                                                         |
| ---------------------------- | ------------------------------------------------------------ |
| 添加设备                     | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=添加设备) |
| 批量随机添加设备             | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=批量随机添加设备) |
| 批量录入设备序列号并添加设备 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=批量录入设备序列号并添加设备) |
| 获取设备信息                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取设备信息) |
| 获取设备列表                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取设备列表) |
| 修改设备信息                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=修改设备信息) |
| 删除设备                     | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=删除设备) |
| 批量删除设备                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=批量删除设备) |
| 重置设备状态                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=重置设备状态) |
| 批量禁用启用设备                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=批量禁用启用设备) |
| 获取未激活设备密钥                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取未激活设备密钥) |
| 获取子设备列表                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取子设备列表) |
| 获取网关设备列表                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取网关设备列表) |
| 获取网关信息                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取网关信息) |
| 获取子设备信息                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=获取子设备信息) |
| 远程访问开关                 | [查看链接](uiot-stack/IoT平台开发指南/设备管理?id=远程访问开关) |
