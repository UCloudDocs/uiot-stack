...
* 边缘端开发
  ...
  * 本地控制台开发指南
    * [API列表](/uiot-stack/边缘端开发/本地控制台开发/API列表)
    * [登录管理](/uiot-stack/边缘端开发/本地控制台开发/登录管理)
    * [函数管理](/uiot-stack/边缘端开发/本地控制台开发/函数管理)
    * [驱动管理](/uiot-stack/边缘端开发/本地控制台开发/驱动管理)
    * [消息路由](/uiot-stack/边缘端开发/本地控制台开发/消息路由)
    * [应用管理](/uiot-stack/边缘端开发/本地控制台开发/应用管理)
* 直连设备开发指南
  * 设备注册
